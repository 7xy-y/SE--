...
export default class MissionList extends Component {
    ...
    getMID(record) {
        ...
        mfile = record.file;
        mtag = record.tag;
        mpublisher=record.publisher;
        this.state.mission_ID = mid;
        this.state.file=mfile;
        this.state.tag=mtag;
        this.state.publisher=mpublisher;
        this.props.history.push({ pathname: '/UserCenter/PictureMark', state:
    ...
    render() {
        ...
        return (
            <div>
                 <br /><br /><br /><br />
                <span style={{ color: 'black', fontSize: '2em' }}>可选任务</span>
